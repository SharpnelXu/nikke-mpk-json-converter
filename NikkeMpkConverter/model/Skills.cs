...
namespace NikkeMpkConverter.model
{
    ...
    public enum FunctionType
    {
        ...
        ForcedReload = 206,
        AtkBuffChange = 300,
        BonusRangeDamageChange = 301,
        CallingMonster = 302,
        ChangeMaxSkillCoolTime1 = 303,
        CurrentHpRatioDamage = 334,
        DamageBio = 396,
        DamageEnergy = 397,
        DamageFunctionUnable = 399,
        DamageMetal = 401,
        DamageRatioEnergy = 402,
        DamageRatioMetal = 403,
        DamageShareInstantUnable = 470,
        GainUltiGauge = 650,
        ImmuneAttention = 760,
        ImmuneBio = 770,
        ImmuneChangeCoolTimeUlti = 780,
        ImmuneDamage_MainHp = 800,
        ImmuneEnergy = 801,
        ImmuneForcedStop = 802,
        ImmuneGravityBomb = 803,
        ImmuneInstantDeath = 804,
        ImmuneMetal = 806,
        ImmuneOtherElement = 807,
        ImmuneTaunt = 809,
        InstantDeath = 960,
        LinkAtk = 970,
        LinkDef = 980,
        None = 0,
        OutBonusRangeDamageChange = 1010,
        PartsHpChangeUIOff = 1040,
        PartsHpChangeUIOn = 1050,
        PartsImmuneDamage = 1060,
        PlusDebuffCount = 1080,
        Silence = 1160,
        StatBioResist = 1220,
        StatBurstSkillCoolTime = 1240,
        StatChargeTimeImmune = 1270,
        StatEnergyResist = 1320,
        TargetPartsId = 1510,
        DmgReductionExcludingBreakCol = 1600,
        DurationBuffCheckImmune = 1610,
        ImmediatelyBuffCheckImmune = 1620,
        ChangeHurtFxExcludingBreakCol = 1630,
        PlusBuffCount = 1640,
        DamageShareLowestPriority = 1700
    }
